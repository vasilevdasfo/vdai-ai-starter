...
if ((Test-Path (Join-Path $resolved $instructionFile)) -or ($skills | Where-Object { Test-Path (Join-Path $resolved "skills\$_") })) {
...
Write-Host "VDAI AI Starter · Dmitrii Pro installed. Restart the agent and run both verification turns from INSTALL.md."
