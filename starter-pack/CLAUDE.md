...
Prefer a small real task with an artifact over a long questionnaire. A result is complete only when the artifact can be opened and the promised check has passed. A second reply on the same topic must continue numbering rather than restart at `1`.
