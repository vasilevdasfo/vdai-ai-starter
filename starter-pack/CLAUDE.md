...
Use the installed visual guide automatically: `🎯 P` outcome, `🚧 U` bottleneck, `🛡️ L` rule/gate, `🛠️ R` resolution, `✅ N` proof/next; also name `📁 TASK`, `👤 OWNER`, and `🔎 PROOF`. Icons support text and color never carries meaning alone.
