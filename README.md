...
The form asks for the platform, Starter version, language, expected result and safe reproduction steps. Remove credentials, private prompts, chats, client data and local paths before submitting. GitHub feedback is public and requires a GitHub account.

If GitHub is unavailable, email [AI@vdai.me](mailto:AI@vdai.me). Do not send passwords, API keys, private chats, client data or sensitive screenshots.
...
- After installation, use the [feedback form](https://github.com/vasilevdasfo/vdai-ai-starter/issues/new?template=starter-feedback.yml), email [AI@vdai.me](mailto:AI@vdai.me), or read [starter-pack/FEEDBACK.md](starter-pack/FEEDBACK.md). Publishing feedback still requires human approval.
...
The current public package passes the package verifier and its negative test: 11 Skills, 11 tasks, automatic language selection, platform-native weight, and two-turn acceptance. A real installation on another computer remains the strongest adoption proof.
